          ...
          <div className="section-body mt-3 mb-5">
            <div className="container-fluid">
              ...
              <div class="card-deck">
                ...
                <div class="card bg-light">
                  <img class="card-img-top" src="https://live.staticflickr.com/2912/13981352255_fc59cfdba2_b.jpg" alt="Card image cap" />
                  <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                ...
                <div class="card bg-light">
                  <img class="card-img-top" src="https://miro.medium.com/max/3000/1*MI686k5sDQrISBM6L8pf5A.jpeg" alt="Card image cap" />
                  <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                          ...
                          <tr>
                            <td>
                              ...
                              <div className="progress progress-xs bg-white">
                                <div className="progress-bar bg-info progress-bar-striped progress-bar-animated" role="progressbar" style={{ width: '35%' }} aria-valuenow="35" aria-valuemin="0" aria-valuemax="100"></div>
                              </div>
                            </td>
                          </tr>
                          <tr>
                            <td>
                              ...
                              <div className="progress progress-xs">
                                <div className="progress-bar bg-info progress-bar-striped progress-bar-animated" role="progressbar" style={{ width: '25%' }} aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                              </div>
                            </td>
                          </tr>
                          <tr>
                            <td>
                              ...
                              <div className="progress progress-xs bg-white">
                                <div className="progress-bar bg-info progress-bar-striped progress-bar-animated" role="progressbar" style={{ width: '15%' }} aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
                              </div>
                            </td>
                          </tr>
                          <tr>
                            <td>
                              ...
                              <div className="progress progress-xs">
                                <div className="progress-bar bg-info progress-bar-striped progress-bar-animated" role="progressbar" style={{ width: '20%' }} aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
                              </div>
                            </td>
                          </tr>
                          <tr>
                            <td>
                              ...
                              <div className="progress progress-xs bg-white">
                                <div className="progress-bar bg-info progress-bar-striped progress-bar-animated" role="progressbar" style={{ width: '11%' }} aria-valuenow="11" aria-valuemin="0" aria-valuemax="100"></div>
                              </div>
                            </td>
                          </tr>
                        </tbody>
